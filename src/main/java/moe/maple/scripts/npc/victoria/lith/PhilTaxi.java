...
public class PhilTaxi extends NpcScript {
    ...
    private void firstCityIntro() {
        var cityDescriptions = new MenuItem[] {
                MenuItem.of(Moematter.map(Victoria.LithHarbor), buildIntro(
                ...
                MenuItem.of(Moematter.map(Victoria.Ellinia), buildIntro(
                ...
                MenuItem.of(Moematter.map(Victoria.Perion), buildIntro(
                ...
                MenuItem.of(Moematter.map(Victoria.Henesys), buildIntro(
                ...
                MenuItem.of(Moematter.map(Victoria.Kerning), buildIntro(
                ...
                MenuItem.of(Moematter.map(Victoria.Nautilus), buildIntro(
                ...
                MenuItem.of(Moematter.map(Victoria.Sleepywood), buildIntro(
